...
// The contract allows only its creator to create new tokens 
// Anyone can send tokens to each other without a need for registering with a username and password, all you need is an Ethereum wallet 
